    ...
    >
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl border border-neutral-200 bg-[#FDFCF9] shadow-2xl">
        <button
          ...
          className="absolute right-4 top-4 z-10 flex h-9 w-9 items-center justify-center rounded-full bg-white/90 text-neutral-500 shadow-sm transition hover:bg-neutral-100 hover:text-neutral-900"
        >
          <X size={18} />
        </button>

        <div className="h-1.5 bg-[#E5AD23]" />

        <div className="px-7 pb-8 pt-9 text-center sm:px-9">
          <span className="inline-flex rounded-full bg-[#E5AD23]/10 px-4 py-1.5 text-xs font-bold uppercase tracking-[0.16em] text-[#9A7415]">
            Admissions Open
          </span>
