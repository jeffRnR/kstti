// src/components/home/Campuses.tsx
...
const campuses = [
  {
    ...
    location: "Kerugoya, Kirinyaga County",
    description:
    ...
    <section className="section bg-white">
      <div className="container-xl">
        <div className="text-center">
          <span className="tagline-center">Our Campuses</span>
          <h2 className="section-title">Study From Either Of Our Two Campuses</h2>
            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="mt-3 flex items-center gap-2 text-[#C4931A]">
                  ...
                  <span className="text-sm font-semibold">{campus.location}</span>
                </div>
